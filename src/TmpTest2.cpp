...
void tmp2() {
  int x = 10;
  auto l1 = [x](int y) mutable {
    x = x + y;
    return x + y;
  };
  auto l2 = [&x](int y) mutable {
    x = x + y;
    return x + y;
  };
...
class AA9 {
 public:
  ...
  AA9() { cout << "Default constructor" << endl; }
...
struct Login : Msg {
  Login(string cmd, int id, string _username)
      : Msg{cmd, id}, username(_username){};
  std::string username{""};
};
...
class AA11a {
 public:
  ...
  AA11a() { cout << "Default constructor" << endl; }
...
struct C17 {
  ...
  void getInfo1() { cout << "C17 getInfo1" << endl; };

  virtual void getInfo2() { cout << "C17 getInfo2" << endl; };
};
...
struct C17a : public C17 {
  ...
  void getInfo2() override { cout << "C17a getInfo2:..." << endl; }
};

struct C17b : public C17a {
  C17b() : C17a("FromC17b") {}
  void getInfo2() { cout << "C17b getInfo2:..." << endl; }
};
...
class C18b : public C18a {
 public:
  void foo() override { cout << "heh" << endl; }
  string b = "BBbbbbbbb";
  int b1 = 20;
};
